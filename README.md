...
This folder contains the codes for conducting the paired comparison experiment and analyzing the data. We used these codes in our paper [Link](https://dl.acm.org/citation.cfm?id=2931016). Codes in this repository are supposed to work as a template such that the codes should work for all paired comparision expreiments with little modifications.
